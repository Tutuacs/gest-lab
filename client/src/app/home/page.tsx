      ...
      <div className="bg-white shadow rounded-3xl p-12 w-full max-w-3xl grid grid-cols-1 md:grid-cols-[1fr_10px_1fr] gap-6">
        <div className="flex flex-col gap-4">
          <Link href="/equipament">
            <button className="w-full py-10 text-white bg-green-600 border-gray-200 rounded-3xl hover:bg-green-800 transition-all duration-300 ease-in-out">
              Equipamentos
            </button>
          </Link>
          <Link href="/event">
            <button className="w-full py-10 text-white bg-indigo-900 border border-gray-200 rounded-3xl hover:bg-indigo-950 transition-all duration-300 ease-in-out">
              Eventos
            </button>
          </Link>
        </div>
        ...
        <div className="flex flex-col gap-4">
          <Link href="/certificados">
            <button className="w-full py-5 text-gray-900 bg-white border border-gray-200 rounded-2xl hover:bg-gray-100 transition-all duration-300 ease-in-out">
              Certificados
            </button>
          </Link>
