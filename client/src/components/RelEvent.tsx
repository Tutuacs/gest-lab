      ...
      {showSummary && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-50">
          <div className="bg-white p-6 rounded-xl shadow max-w-md w-full">
            <h2 className="text-xl font-bold mb-4">Resumo da Consulta</h2>
            <p className="text-lg">
              Valor total:{' '}
            ...
            <div className="mt-4 space-y-2">
              {aggregate.map(item => (
                <p key={item.type}>
                  ...
                  : {item.count} evento(s) - Subtotal: R${' '}
            ...
            <button
              ...
              className="mt-6 w-full bg-indigo-950 text-white py-2 rounded hover:bg-indigo-900"
            >
              Fechar
            </button>
          </div>
      ...
      <div className="overflow-x-auto">
        <div className="flex flex-nowrap gap-4 p-4 bg-white shadow rounded-xl mb-6 overflow-x-auto">
          ...
          >
            ...
            <option value="MAINTENANCE_PREVENTIVE">
