                  ...
                  <li key={item.id} className="p-4 border rounded bg-white">
                    ...
                    {item.Certified && (
                      <div className="mt-2 text-sm">
                        ...
                        <p><strong>Situação:</strong> {item.Certified.valid}</p>
                      </div>
                    )}
                    {lastEvent && (
                      <div className="mt-2 text-sm">
                        <p><strong>Último Evento:</strong> {lastEvent.eventType}</p>
                        <p><strong>Descrição:</strong>{lastEvent.description}</p>
                        <p><strong>Tipo:</strong> {lastEvent.eventType}</p>
